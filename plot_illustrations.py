...
ylim_std = {'MAG': (18.01, 12.49), 'Re': (5.01, 34.99), 'n': (0.01, 5.99),
            'AR': (0.41, 0.79), 'PA': (35.01, 64.99)}

ylim_disk = {'MAG': (19.01, 13.49), 'Re': (15.01, 34.99), 'n': (0.01, 2.99),
             'AR': (0.21, 0.89), 'PA': (35.01, 64.99)}

ylim_bulge = {'MAG': (19.01, 13.49), 'Re': (5.01, 19.99), 'n': (2.01, 7.99),
